...
\hyphenation{profesionálněji}
\begin{quotation}
Čím více \texttt{druhů}, {\itshape\bfseries řezů}, {\small velikostí}, barev písma {\fontfamily{cmss}\selectfont a~jiných efektů} použijeme, tím \textit{profesionálněji} bude dokument vypadat. Čtenář tím {\tiny bude} vždy {\huge \textbf{nadšen!}}
\end{quotation}
